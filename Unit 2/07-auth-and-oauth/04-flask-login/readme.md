...
### Brendon's Notes
- The @login_required custom decorator can be removed and replaced with Flask-Login's provided @login_required decorator; the decorators will need to be modified to use current_user instead of sessions